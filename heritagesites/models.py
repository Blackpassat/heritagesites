...
class HeritageSite(models.Model):
    ...
    def sub_region_names(self):
        ...
        for region in sub_regions:
            try:
                name = region.location.sub_region.sub_region_name
            except:
                name = None
            if name is None:
                continue
    ...
    def intermediate_region_names(self):
        ...
        # string join method.
        inter_regions = self.country_area.select_related('location__intermediate_region').order_by('location__intermediate_region__intermediate_region_name')

        names = []
        for region in inter_regions:
            try:
                name = region.location.intermediate_region.intermediate_region_name
            except:
                name = None
            if name is None:
                continue
...
class Planet(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'UNSD M49 Planet'
...
class Location(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'UNSD M49 Location'
